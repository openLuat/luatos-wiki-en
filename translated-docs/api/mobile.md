...
|mobile.CONF_USB_ETHERNET|number|Usb Ethernet card control of cellular network module, bit0 switch 1, on 0 off, bit1 mode 1NAT,0 independent IP (currently mandatory to 1),bit2 protocol 1ECM,0RNDIS, set in flight mode|
